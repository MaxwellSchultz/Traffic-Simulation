...
public class SinkLogger : MonoBehaviour
{
    private static SinkLogger instance;
    ...
    public static SinkLogger Instance
    {
        get
        {
            lock (padlock)
            {
                if (instance == null)
                {
                    ...
                    instance = FindObjectOfType<SinkLogger>();

                    // If no logger is found, create a new GameObject and attach the logger
                    if (instance == null)
                    {
                        GameObject loggerObject = new GameObject("SinkLogger");
                        instance = loggerObject.AddComponent<SinkLogger>();
                    }
                }
                return instance;
            }
    ...
    private void InitializeLogger()
    {
        ...
        filePath = Path.Combine(Application.dataPath, "sinkLog.txt");
